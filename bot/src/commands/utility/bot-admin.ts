...
wrapAsSubcommand(data as any, 'disable', 'Deactivate a command for this server. Use the commands subcommand for a visual overview and multi-select.', disableCmd as any);
